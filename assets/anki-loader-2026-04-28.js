...
$(function () {
            ...
            success: function (data) {
              ...
              $.ajax({
                ...
                success: function (data) {
                  ...
                  strDetails = strDetails.replace(/(\p{Script=Han})/gu, '<a class="kanjiHover" href="https://quezako.com/japanese/anki/anki.php?kanji=$1">$1</a>');
  ...
  function addOffset(match, ...args) {
    ...
    strKanjiLinks += `<a href='https://quezako.com/japanese/anki/vocabulary.php?kanji=${args[0]}&kana=${arrDict[args[1]]}&lang=en'><img src='favicon-f435b736ab8486b03527fbce945f3b765428a315.ico' width=16 style='vertical-align:middle'>Q Voc</a>`;
    strKanjiLinks += `<a href='https://quezako.com/japanese/anki/anki.php?kanji=${args[0]}'><img src='favicon-f435b736ab8486b03527fbce945f3b765428a315.ico' width=16 style='vertical-align:middle'>Q Kanji</a>`;
  ...
  function main() {
    ...
    if ($('#kanji_key').length) {
      ...
      $('#external_links').append(" <a href='https://www.google.com/search?q=-漫画 " + kanji_key + " -" + kana_key + " イラスト&tbm=isch&hl=fr&sa=X'><img src='favicon-49263695f6b0cdd72f45cf1b775e660fdc36c606.ico' width=16 style='vertical-align:middle'>G img kanji</a>");
      $('#external_links').append(" <a href='https://www.google.com/search?q=-漫画 " + kanji_key + " " + kana_key + " イラスト&tbm=isch&hl=fr&sa=X'><img src='favicon-49263695f6b0cdd72f45cf1b775e660fdc36c606.ico' width=16 style='vertical-align:middle'>G img kana</a>");
  ...
  let url = 'http://localhost/japanese/anki/';
  ...
  $.ajax({
    ...
    error: function () {
      url = 'https://quezako.com/japanese/anki/';
    }
  });
